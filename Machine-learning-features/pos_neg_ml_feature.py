...
# sys.path.append("./Preprocessing module/")
# sys.path.append("./Machine learning features/Preprocessing module")
...
# 4. Load classifier
# clf = pickle.load(open('./Machine-learning-features/wac_classifier.pkl','rb'))
def getPKLfile():
    with open('./Machine-learning-features/wac_classifier.pkl', 'rb') as input:
        clf = pickle.load(input)
        return  clf
    # input = open('./Machine-learning-features/wac_classifier.pkl','rb')
    # try:
