...
"""
import sys
sys.path.append("C:\\Users\\wuanc\\PycharmProjects\\filetools\\Preprocessing module")
...
def create_bigram_scores():
    posdata = tp.seg_fil_senti_excel("/sentiment review set/pos_review.xlsx", 1, 1)
    negdata = tp.seg_fil_senti_excel("/sentiment review set/neg_review.xlsx", 1, 1)
...
store_classifier(BernoulliNB(),train_set,'wac_classifier.pkl')
